...
- wraps World Anvil API (only wrapper package we need since WorldAnvil has no official SDK)
...
- [HUMAN-REVIEW] Add workspace generator scripts
- [BOT-TODO] Remove @crit-fumble/discord and @crit-fumble/openai packages - use SDKs directly in core
- [BOT-TODO] Configure workspace-specific ESLint rules
- [BOT-TODO] Set up TypeScript project references for remaining packages
- [BOT-TODO] Add build caching and optimization
- [BOT-TODO] Document unified build process
- [BOT-TODO] Add Node.js version requirements

### @crit-fumble/worldanvil (only wrapper package we need)
- [BOT-TODO] move authentication functionality into worldanvil api client
- [BOT-TODO] ensure proper architecture; clients accept config models in their constructors, services accept clients in their constructors, controllers accept services in their constructors, and views accept controllers; these layers should stay cleanly separated
- [BOT-TODO] remove all completed FUTURE: and TODO: comments in code base

### @crit-fumble/core
- [BOT-TODO] Remove dependencies on @crit-fumble/discord and @crit-fumble/openai packages
- [BOT-TODO] Add direct dependencies on discord.js and openai SDKs
- [BOT-TODO] Update services to use Discord.js and OpenAI directly instead of through wrappers
- [COMPLETED] Add dependency on @crit-fumble/worldanvil package
- [COMPLETED] update configs to simply accept a value instead of reading from .env; no need for backward compatibility
...
- [COMPLETED] Create a migration to drop the majority of unused tables
- [BOT-TODO] unify discord, openai, and worldanvil services at the service layer, ensuring services accept clients in their contrutors and no service, control, or view dependencies. Use our model library and prisma types when possible
- [BOT-TODO] update controllers for handling API requests; controllers should accept services as dependencies, and not depend on other controllers, cllients, or views
- [BOT-TODO] unit test the hell out of everything
- [BOT-TODO] remove all completed FUTURE: and TODO: comments in code base

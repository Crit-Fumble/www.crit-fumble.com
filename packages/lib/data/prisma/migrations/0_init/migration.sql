...
-- CreateTable
CREATE TABLE "UserDndBeyond" (
    "id" TEXT NOT NULL,
    "name" TEXT,

    CONSTRAINT "UserDndBeyond_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "UserRoll20" (
    "id" TEXT NOT NULL,
    "slug" TEXT,
    "name" TEXT,
...
-- CreateTable
CREATE TABLE "UserWorldAnvil" (
    "id" TEXT NOT NULL,
    "slug" TEXT,
    "name" TEXT,

    CONSTRAINT "UserWorldAnvil_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "dd_beyond" FOREIGN KEY ("dd_beyond") REFERENCES "UserDndBeyond"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "discord" FOREIGN KEY ("discord") REFERENCES "UserDiscord"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "roll20" FOREIGN KEY ("roll20") REFERENCES "UserRoll20"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "world_anvil" FOREIGN KEY ("world_anvil") REFERENCES "UserWorldAnvil"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

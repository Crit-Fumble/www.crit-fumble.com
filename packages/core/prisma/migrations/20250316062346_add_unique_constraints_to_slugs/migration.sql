/*
  ...
  - A unique constraint covering the columns `[slug]` on the table `RpgSystem` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "RpgSystem_slug_key" ON "RpgSystem"("slug");

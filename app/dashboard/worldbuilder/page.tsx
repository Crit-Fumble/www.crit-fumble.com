...
export const metadata: Metadata = {
  title: "Worldbuilder Dashboard | Crit-Fumble Gaming",
  description: "Create and manage worlds, locations, and lore",
};
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-center mb-6">
              Coming Soon! This dashboard will integrate with World Anvil for comprehensive world building.
            </p>
            
            <div className="text-left max-w-md mx-auto mb-6">
              <h3 className="font-semibold mb-2">Planned Features:</h3>
              <ul className="list-disc list-inside text-sm space-y-1">
                <li>World Anvil integration</li>
                <li>Article management</li>
                <li>Location management</li>
                {/* <li>Location management</li>
                <li>Timeline creation</li>
                <li>Faction tracking</li>
                <li>Lore organization</li>
                <li>Map integration</li>
                <li>World sharing tools</li> */}
              </ul>
            </div>

...
export const metadata: Metadata = {
  title: "Game Master Dashboard | Crit-Fumble Gaming",
  description: "Run your campaigns and manage your games",
};
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-center mb-6">
              Coming Soon! This dashboard will help you manage campaigns, NPCs, and game sessions.
            </p>
            ...
            {/* <div className="text-left max-w-md mx-auto mb-6">
              ...
              <ul className="list-disc list-inside text-sm space-y-1">
                ...
                <li>NPC creation and tracking</li>
                <li>Session planning tools</li>
                <li>Player character oversight</li>
                <li>World building integration</li>
                <li>Encounter builders</li>
              </ul>
            </div> */}

...
export const metadata: Metadata = {
  title: "Moderator Dashboard | Crit-Fumble Gaming",
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-center mb-6">
              Coming Soon! This dashboard will provide community moderation tools.
            </p>
            
            {/* <div className="text-left max-w-md mx-auto mb-6">
              <h3 className="font-semibold mb-2">Planned Features:</h3>
              <ul className="list-disc list-inside text-sm space-y-1">
                <li>User reports management</li>
                <li>Content moderation</li>
                <li>Discord integration</li>
                <li>Ban/warn system</li>
            ...
            <div className="flex gap-2 justify-center">
              ...
              <a className={linkClass} href="/admin">Admin Tools</a>
            </div>
          </CardContent>
        </Card>
      </div>

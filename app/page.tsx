...
export const metadata: Metadata = {
  ...
  description: "Welcome to Crit Fumble Gaming! We're a gaming group and have players with some of the worst luck and dumbest ideas. We started as an in-person group in the Midwest United States, but have moved our campaigns online and have since grown to include members all over the world.",
};

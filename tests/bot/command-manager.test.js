...
import CommandManager from '../../src/bot/managers/CommandManager.js';
...
jest.mock('../../src/bot/commands/general/ping.js', () => ({
  __esModule: true,
  default: {
    data: {
      name: 'ping',
...
jest.mock('../../src/bot/commands/admin/restart.js', () => ({
  __esModule: true,
  default: {
    data: {
      name: 'restart',
    ...
    test('should register commands from all folders', async () => {
      ...
      global.import = jest.fn().mockImplementation(path => {
        if (path.includes('ping.js')) {
          return import('../../src/bot/commands/general/ping.js');
        }
        if (path.includes('restart.js')) {
          return import('../../src/bot/commands/admin/restart.js');
        }

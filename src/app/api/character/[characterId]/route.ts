 ...
 */
import { createCharacterHandler, deleteCharacterHandler, getCharacterHandler, updateCharacterHandler } from '@lib/next/controllers/Character/CharacterController';
